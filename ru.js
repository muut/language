moot.language = {
   ...
   c_acc1: 'Твой аккаунт теперь работает на всех сайтах использующих Moot',
   ...
   comment1: 'Твой комментарий будет первым...',
   comment: 'Комментировать...',
   edit: 'изменить',
   email: 'Email',
   email_taken: 'Этот email уже используется',
   emailtip: 'Твой email никто не узнает',
   enter: 'ctrl + enter',
   ...
   unwall: 'больше ни за чем не следить',
   unwatch: 'Не следить',
