moot.language = {
  ...
  custom_path1: 'Другое',
  custom_path: 'Введите другой путь',
  ...
  retire_desc: 'Заблокированные темы не будут отображаться в уведомлениях и не поднимутся вверх.',
  retired_desc: 'Эта тема заблокирована. Новые ответы не поднимут тему вверх.',
  is_retired: 'Эта тема была заблокирована',

  unretire: 'Разблокировать',
  unretire_title: 'Разблокировать тему',
  unretire_desc: 'Эта тема поднимется вверх.',
  quote_help1: 'Select',
