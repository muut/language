moot.language = {
   ...
   username_fail: 'از خروف، اعداد یا خط ی تیره استفاده کنید',
   bold: 'برجسته',
   italics: 'مابل',
   monospaced: 'در عرض',
   domain: 'لینک مبحث',
   ...
   c_acc1: 'حساب کاربری شما در کلیه سایت هایی که از موت استفاده میکنند معتبر خواهد بود',
