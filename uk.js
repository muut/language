moot.language = {
  ...
  ban_acc: 'Обліковий запис заблоковано',
  ban_msg: 'Для вашого облікового запису тимчасово заблоковано можливість писати на цьому форумі через порушення правил форума.',
